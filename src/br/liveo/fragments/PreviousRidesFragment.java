...
public class PreviousRidesFragment extends Fragment{
	...
	private TextView ride_status;
	private TextView ridesMsg;
	
    public static PreviousRidesFragment newInstance() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.summerypervious, container, false);
		
		
		rootView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams.MATCH_PARENT ));	
		
		progressView = (RelativeLayout)rootView.findViewById(R.id.progressdialogview);
		listCurrentRides = (ListView)rootView.findViewById(R.id.periouslist);
	...
	private void loadData() {
		...
		try {
			...
			requestParams.put("typeData","Completed");
