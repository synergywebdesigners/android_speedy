...
public class MainActivity extends Activity {
    ...
    private void getClientToken() {
        mHttpClient.get(OptionsActivity.getClientTokenUrl(this), new AsyncHttpResponseHandler() {
			...
			@Override
			public void onFailure(int statusCode, Header[] arg1, byte[] errorMessage,
					Throwable error) {
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] response) {
				...
				try {
                    ...
                    mClientToken=json.getString("clientToken");
                	...
                	showDialog("Unable to get a client token. Status code: " + arg0 + ". Error:" +
                            response.toString());
    ...
    public void onBuyClick(View v) {
        ...
        if (OptionsActivity.getFormType(this) == OptionsActivity.CUSTOM) {
            ...
            Customization customization = new CustomizationBuilder()
                    .primaryDescription("Trip Fare :"+getIntent().getStringExtra("trip_id"))
                    .secondaryDescription(" "+getIntent().getStringExtra("trip_time")+" "+getIntent().getStringExtra("trip_date"))
                    .amount(""+getIntent().getStringExtra("fare"))
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
          ...
          intent.putExtra("fare", fare);
            ...
            Log.d("NONCE ++++>", " : "+data.getStringExtra(BraintreePaymentActivity.EXTRA_PAYMENT_METHOD_NONCE));
