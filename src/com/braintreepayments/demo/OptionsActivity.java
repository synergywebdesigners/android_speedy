...
public class OptionsActivity extends Activity implements OnCheckedChangeListener {
    ...
    private static final String SANDBOX_BASE_SERVER_URL = "http://phbjharkhand.in/speedyTaxi/transaction.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bt_options);
    ...
    public static String getClientTokenUrl(Context context) {
        ...
        return getEnvironmentUrl(context);
    }
